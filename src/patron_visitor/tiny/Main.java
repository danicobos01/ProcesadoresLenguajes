     ...
     if (args[0].equals("-lex")) {  
    	...
    	*/ 
         ...
         */
         ...
         prog = new Prog_con_decs(new Decs_muchas(new Decs_vacia(), new DecVar(new SL("suma"), new Int())), 
		...
		new Ins_muchas(new Ins_muchas(new Ins_una(
				...
				new While(
						...
						new Ins_muchas(new Ins_una(
								new Invoc_proc(new SL("inserta_nombre"), new Pr_muchos(new Pr_vacio(), new Id(new SL("arbol"))))),
								new Asignacion(new Id(new SL("i")), new Suma(new Id(new SL("i")), new NumEnt(new SL("1"))))))),
...
Dec decproc3 = new DecProc(new SL("escribe_nombres"),
		...
		new Ins_una(
				new If_then(
						...
						new Ins_muchas(new Ins_muchas(new Ins_muchas(new Ins_una(
								new InvocProc(new SL("escribe_nombres"), new Pr_muchos(new Pr_vacio, new AccesoRegistro(new Indireccion(new Id(new SL("arbol"))), new SL("izq"))))),
								new Write(new AccesoRegistro(new Indireccion(new Id(new SL("arbol"))), new SL("nombre")))),
								new NewLine()),
								new InvocProc(new SL("escribe_nombres"), new Pr_muchos(new Pr_vacio(), new AccesoRegistro(new Indireccion(new Id(new SL("arbol"))), new SL("der"))))))));

Instrucciones ins1 = new Ins_muchas(new Ins_muchas(new Ins_muchas(new Ins_muchas(new Ins_muchas(new Ins_muchas(new Ins_una(
		new Invoc_proc(new SL("lee_nombres"), new Pr_muchos(new Pr_vacio(), new Id(new SL("nombres"))))),
		...
		new NewLine()),
		new Invoc_proc(new SL("escribe_nombres"), new Pr_muchos(new Pr_vacio(), new Id(new SL("arbol")))));   	
...
Prog_con_decs prog = new Prog_con_decs(declarationSection, instructionSection);
